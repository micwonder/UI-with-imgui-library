...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Querying Window Status (Focused/Hovered etc.)"))
    {
        ...
        if (embed_all_inside_a_child_window)
            ImGui::BeginChild("outer_child", ImVec2(0, ImGui::GetFontSize() * 20.0f), ImVec2(0, 0), true);
        ...
        ImGui::BeginChild("child", ImVec2(0, 50), ImVec2(0, 0), true);
...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Child windows"))
    {
        ...
        // Child 1: no border, enable horizontal scrollbar
        {
            ...
            ImGui::BeginChild("ChildL", ImVec2(ImGui::GetContentRegionAvail().x * 0.5f, 260), ImVec2(0, 0), false, window_flags);
            for (int i = 0; i < 100; i++)
        ...
        // Child 2: rounded border
        {
            ...
            ImGui::BeginChild("ChildR", ImVec2(0, 260), ImVec2(0, 0), true, window_flags);
        ...
        //   the POV of the parent window). See 'Demo->Querying Status (Edited/Active/Hovered etc.)' for details.
        {
            ...
            ImGui::BeginChild("Red", ImVec2(200, 100), ImVec2(0, 0), true, ImGuiWindowFlags_None);
            for (int n = 0; n < 50; n++)
    ...
    if (ImGui::TreeNode("Scrolling"))
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            const bool child_is_visible = ImGui::BeginChild(child_id, ImVec2(child_w, 200.0f), ImVec2(0, 0), true, child_flags);
            if (ImGui::BeginMenuBar())
            {
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            bool child_is_visible = ImGui::BeginChild(child_id, ImVec2(-100, child_height), ImVec2(0, 0), true, child_flags);
            if (scroll_to_off)
        ...
        ImGui::BeginChild("scrolling", scrolling_child_size, ImVec2(0, 0), true, ImGuiWindowFlags_HorizontalScrollbar);
        ...
        if (show_horizontal_contents_size_demo_window)
        {
            ...
            if (show_child)
            {
                ImGui::BeginChild("child", ImVec2(0, 0), ImVec2(0, 0), true);
                ImGui::EndChild();
            }
            ImGui::End();
        }
...
static void ShowDemoWindowColumns()
{
    ...
    if (ImGui::TreeNode("Horizontal Scrolling"))
    {
        ...
        ImGui::BeginChild("##ScrollingRegion", child_size, ImVec2(0, 0), false, ImGuiWindowFlags_HorizontalScrollbar);
        ImGui::Columns(10);
...
void ImGui::ShowAboutWindow(bool* p_open)
{
    ...
    if (show_config_info)
    {
        ...
        ImGui::BeginChildFrame(ImGui::GetID("cfg_infos"), child_size, ImVec2(0, 0), ImGuiWindowFlags_NoMove);
...
void ImGui::ShowStyleEditor(ImGuiStyle* ref)
{
    ...
    if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None))
    {
        ...
        if (ImGui::BeginTabItem("Colors"))
        {
            ...
            ImGui::BeginChild("##colors", ImVec2(0, 0), ImVec2(0, 0), true, ImGuiWindowFlags_AlwaysVerticalScrollbar | ImGuiWindowFlags_AlwaysHorizontalScrollbar | ImGuiWindowFlags_NavFlattened);
...
static void ShowExampleMenuFile()
{
    ...
    if (ImGui::BeginMenu("Options"))
    {
        ...
        ImGui::BeginChild("child", ImVec2(0, 60), ImVec2(0, 0), true);
        for (int i = 0; i < 10; i++)
...
struct ExampleAppConsole
{
    ...
    void    Draw(const char* title, bool* p_open)
    {
        ...
        if (ImGui::BeginChild("ScrollingRegion", ImVec2(0, -footer_height_to_reserve), ImVec2(0, 0), false, ImGuiWindowFlags_HorizontalScrollbar))
        {
...
struct ExampleAppLog
{
    ...
    void    Draw(const char* title, bool* p_open = NULL)
    {
        ...
        if (ImGui::BeginChild("scrolling", ImVec2(0, 0), ImVec2(0, 0), false, ImGuiWindowFlags_HorizontalScrollbar))
        {
            if (clear)
                Clear();
            if (copy)
...
static void ShowExampleAppLayout(bool* p_open)
{
    ...
    if (ImGui::Begin("Example: Simple layout", p_open, ImGuiWindowFlags_MenuBar))
    {
        ...
        {
            ImGui::BeginChild("left pane", ImVec2(150, 0), ImVec2(0, 0), true);
            for (int i = 0; i < 100; i++)
            {
    ...
    if (!close_queue.empty())
    {
        ...
        else
        {
            ...
            if (ImGui::BeginPopupModal("Save?", NULL, ImGuiWindowFlags_AlwaysAutoResize))
            {
                ...
                if (ImGui::BeginChildFrame(ImGui::GetID("frame"), ImVec2(-FLT_MIN, 6.25f * item_height), ImVec2(0, 0)))
                {
                    for (int n = 0; n < close_queue.Size; n++)
                        if (close_queue[n]->Dirty)
