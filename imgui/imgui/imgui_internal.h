...
#define IM_DRAWLIST_CIRCLE_AUTO_SEGMENT_MIN                     30
...
//#endif
    ...
    IMGUI_API bool          BeginChildEx(const char* name, ImGuiID id, const ImVec2& size_arg, const ImVec2& cursor_pos, bool border, ImGuiWindowFlags flags);
    ...
    IMGUI_API bool          TextButtonEx(const char* ico, const char* label, const ImVec2& size_arg = ImVec2(0, 0), const ImVec2& cursor_pos = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          TabEx(const char* label, bool selected = false, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
