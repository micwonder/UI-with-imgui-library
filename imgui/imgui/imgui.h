...
namespace ImGui
{
    ...
    //    BeginPopup/EndPopup, etc. where the EndXXX call should only be called if the corresponding BeginXXX function
    //    returned true. Begin and BeginChild are the only odd ones out. Will be fixed in a future update.]
    IMGUI_API bool          BeginChild(const char* str_id, const ImVec2& size = ImVec2(0, 0), const ImVec2& pos = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0);
    IMGUI_API bool          BeginChild(ImGuiID id, const ImVec2& size = ImVec2(0, 0), const ImVec2& pos = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0);
    ...
    IMGUI_API bool          TextButton(const char* ico, const char* label, const ImVec2& size = ImVec2(0, 0), const ImVec2& cursor_pos = ImVec2(0, 0));   // button
    IMGUI_API bool          Tab(const char* label, bool selected = false, const ImVec2& size = ImVec2(0, 0));   // Tab
    ...
    IMGUI_API bool          ConfigList(const char* label, const char* id_label, bool p);
    ...
    IMGUI_API bool          BeginChildFrame(ImGuiID id, const ImVec2& size, const ImVec2& pos = ImVec2(0, 0), ImGuiWindowFlags flags = 0); // helper to create a child window / scrolling region that looks like a normal widget frame
